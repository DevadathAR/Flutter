...
class _VideoPlayerPageState extends State<VideoPlayerPage> {
  ...
  Future<void> _logout() async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => PhoneAuth(), // Return to the login screen
      ),
    );
  }
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            // Move the PopupMenuButton to the MenuAndAcc widget
          ],
        ),
        body: Center(
          child: SizedBox(
              ...
              itemBuilder: (BuildContext context) => [
                PopupMenuItem<String>(
                  ...
                  child: ListTile(
                    ...
                    title: Text(_user!.displayName ?? 'No Name'),
                    subtitle: Text(_user!.phoneNumber ?? 'No Phone Number'),
                  ),
                ),
                PopupMenuItem<String>(
                  value: 'logout',
